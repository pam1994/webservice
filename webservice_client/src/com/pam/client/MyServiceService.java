 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://serivce.pam.com/", wsdlLocation = "http://192.168.8.23:9527/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://serivce.pam.com/", "MyServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.8.23:9527/weather?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://serivce.pam.com/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serivce.pam.com/", "MyServicePort"), MyService.class, features);
    }
